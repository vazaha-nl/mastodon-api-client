 ...
 */
final class AcceptMultipleRequestsRequest extends Request implements RequestInterface
{
    /**
    ...
    {
        return sprintf('/api/v1/notifications/requests/%s/dismiss', urlencode($this->id));
    }
