 ...
 */
final class BookmarkRequest extends \Vazaha\Mastodon\Requests\StatusRequest implements RequestInterface
{
    ...
    {
        return sprintf('/api/v1/statuses/%s/bookmark', urlencode($this->id));
    }
