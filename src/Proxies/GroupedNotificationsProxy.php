...
use Vazaha\Mastodon\Requests\GroupedNotifications\DismissGroupRequest;
use Vazaha\Mastodon\Requests\GroupedNotifications\GetGroupAccountsRequest;
use Vazaha\Mastodon\Requests\GroupedNotifications\GetGroupedRequest;
use Vazaha\Mastodon\Requests\GroupedNotifications\GetNotificationGroupRequest;
use Vazaha\Mastodon\Requests\GroupedNotifications\UnreadGroupCountRequest;
use Vazaha\Mastodon\Results\AccountResult;
use Vazaha\Mastodon\Results\EmptyOrUnknownResult;

class GroupedNotificationsProxy extends Proxy
{
    /**
    ...
    public function getGroupAccounts(
        ...
        $models = $this->apiClient
            ->send(new GetGroupAccountsRequest(
                $group_key,
            ));
     ...
     * @return \Vazaha\Mastodon\Results\EmptyOrUnknownResult<array-key, \Vazaha\Mastodon\Models\EmptyOrUnknownModel>
     *
     * @see https://docs.joinmastodon.org/methods/grouped_notifications/#get-grouped
     */
