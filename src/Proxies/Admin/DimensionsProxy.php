...
class DimensionsProxy extends Proxy
{
     ...
     * @param null|mixed[]       $tag_servers        tag_servers[id]: When `tag_servers` is one of the requested keys, you must provide a trending tag ID to obtain information about which servers are posting the tag
     * @param null|mixed[]       $tag_languages      tag_languages[id]: When `tag_languages` is one of the requested keys, you must provide a trending tag ID to obtain information about which languages are posting the tag
     * @param null|mixed[]       $instance_accounts  instance_accounts[domain]: When `instance_accounts` is one of the requested keys, you must provide a domain to obtain information about popular accounts from that server
